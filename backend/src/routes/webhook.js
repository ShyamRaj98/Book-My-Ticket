...
import { sendConfirmationEmail } from "../services/emailService.js"; // optional
  ...
  async (req, res) => {
    ...
    try {
      if (event.type === "payment_intent.succeeded") {
        ...
        if (!bookingId) {
          console.warn(
            "⚠️ payment_intent.succeeded missing bookingId metadata"
          );
        ...
        try {
          ...
          // Load booking and populate user
          ...
          // Load showtime and populate movie + theater
          ...
          // Generate PDF & send ticket email
          try {
