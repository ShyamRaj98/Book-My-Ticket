...
const TheaterRegister = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const result = await dispatch(register({ ...formData, role: "theater" }));
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <form
        ...
        className="bg-white border border-blue-500 border-y-4 shadow-xl rounded-2xl p-8 w-full max-w-md"
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full mt-2 mb-3 bg-blue-500 text-white py-2 rounded-lg font-semibold hover:bg-blue-600 transition"
        >
          {loading ? "Registering..." : "Register as Theater"}
        </button>
